...
typedef enum {
  ...
  POS_VIRTUAL_KEYBOARD_MODIFIERS_SHIFT = 1,
  POS_VIRTUAL_KEYBOARD_MODIFIERS_CAPSLOCK = 2,
  POS_VIRTUAL_KEYBOARD_MODIFIERS_CTRL = 4,
  POS_VIRTUAL_KEYBOARD_MODIFIERS_SUPER = 64,
  POS_VIRTUAL_KEYBOARD_MODIFIERS_ALTGR = 128,
} PosVirtualKeyboardModifierFlags;
